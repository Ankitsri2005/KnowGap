            ...
            <tbody>
              ${history.slice(0, 8).map(t => `
                <tr>
                  ...
                  <td><button class="btn btn-secondary btn-sm" onclick="window.location.href='results.html?sessionId=${t._id}'">View Report</button></td>
                </tr>
              `).join('')}
            </tbody>
          </table>
          ...
          ${history.map(t => `
            <div class="card" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px">
              ...
              <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap">
                ...
                <button class="btn btn-primary btn-sm" onclick="window.location.href='results.html?sessionId=${t._id}'">View AI Report →</button>
              </div>
            </div>
          `).join('')}
        </div>
